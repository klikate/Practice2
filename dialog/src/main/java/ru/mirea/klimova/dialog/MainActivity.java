package ru.mirea.klimova.dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPickDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ru.mirea.vorontsovaov.dialog.MyDateDialogFragment mDatePickerDialogFragment;
                mDatePickerDialogFragment = new ru.mirea.vorontsovaov.dialog.MyDateDialogFragment();
